...
export default function ProfileForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    const { data: insertedData, error } = await supabase.from("profiles").insert([
      {
        name,
        subjects: subjects.join(","), // store as comma-separated text
    ...
    if (error) {
      ...
      console.log("✅ Data saved:", insertedData);
